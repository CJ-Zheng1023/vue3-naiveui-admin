<template>
  <div class="container full">
    ...
    <field-config v-model:visible="fieldConfigVisible" :id="currentId" />
  </div>
</template>
...
import type { CheckTemplateForList } from '@/api/checkTemplate'
import { queryForList, remove } from '@/api/checkTemplate'
...
const {
  ...
  rowKey,
  resetCondition
} = useTable<CheckTemplateForList, typeof queryForList>({
  api: queryForList,
  params: {
    name: ''
  },
