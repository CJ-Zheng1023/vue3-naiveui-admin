      ...
      <n-form :model="condition" label-placement="left" label-width="100px" label-align="right">
        <n-grid cols="24" responsive="screen"  item-responsive>
          <n-form-item-gi span="24 s:24 m:12 l:8" label="名称">
            <n-input v-model:value="condition.name" placeholder="请输入名称" />
          </n-form-item-gi>
...
import { MemberSearchCondition } from '@/api/member'
const condition = defineModel<MemberSearchCondition>('condition', { required: true })
